...
test("user should be able to enter keyword", async () => {
    render(<Autocomplete />);
...
test("user should be able to see suggestion", async () => {
    render(<Autocomplete />);
    const inputEl = screen.queryByRole("textbox");
    userEvent.type(inputEl, "book");
